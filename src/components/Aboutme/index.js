			...
			<Sobre id="sobre-area">
				...
				<div className="sobre">
					<div className="sobre-left-side">
						<div className="cover-color">
							...
							<div className="joinner">
								...
								<div className="links">
									<a href="https://github.com/RigobertoCaionda" target="_blank" 
										rel="noreferrer">
										<GitHubIcon style={{marginRight: 5, fontSize: '1.2rem'}}/>Github
									</a>
									<a href="https://linkedin.com/in/rigoberto-caionda-2578ab202" 
										target="_blank" rel="noreferrer">
										<LinkedInIcon  style={{marginRight: 5, fontSize: '1.2rem'}}/>LinkedIn
									</a>
									<a href="mailto:rigobertocaionda98@gmail.com">
										<EmailIcon style={{marginRight: 5, fontSize: '1.2rem'}}/>E-mail</a>
								</div>
								<div className="download-documents">
									Baixar CV: <a href="/assets/cv.pdf" download="Rigoberto Caionda">
									PDF</a>, <a href="/assets/cv.docx" 
					...
					<div className="sobre-right-side">
							...
							programação de 
							software.</p>
							<p>Sou uma pessoa muito curiosa e estou sempre disposto a aprender coisas 
							novas.</p>
							<p>
								Estou a procura de uma oportunidade de emprego como programador front end 
								Júnior
